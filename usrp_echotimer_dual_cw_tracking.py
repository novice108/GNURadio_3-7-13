...
# Title: Usrp Echotimer Dual Cw Tracking
# Generated: Sun Feb 12 18:38:32 2023
##################################################
...
class usrp_echotimer_dual_cw_tracking(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Usrp Echotimer Dual Cw Tracking")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Usrp Echotimer Dual Cw Tracking")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_echotimer_dual_cw_tracking")
        ...
        (self.uhd_usrp_source_0).set_min_output_buffer(4194304)
...
def main(top_block_cls=usrp_echotimer_dual_cw_tracking, options=None):
